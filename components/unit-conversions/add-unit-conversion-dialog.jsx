...
export const AddUnitConversionDialog = ({ open, onOpenChange, onSuccess }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add New Unit Conversion</DialogTitle>
          <DialogDescription>
            Create a new unit conversion rule for your inventory system.
          </DialogDescription>
        </DialogHeader>
